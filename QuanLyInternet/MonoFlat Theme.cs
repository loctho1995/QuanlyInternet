...
namespace MonoFlat
{
    ...
    public class MonoFlat_Button : Control
    {
        ...
        public Color InactiveColor
        {
            ...
            { 
                inactiveColor = value;
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), inactiveColor, inactiveColor, 90.0F);                
                this.Invalidate(); 
            }
        }
        ...
        public Color PressedColor
        {
            ...
            { 
                pressedColor = value;
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), pressedColor, inactiveColor, 90.0F);
                this.Invalidate();
            }
        }
        ...
        public Color BorderInactiveColor
        {
            ...
            set
            {
                ...
                P1 = new Pen(borderInactiveColor);
                this.Invalidate();
            }
        }
        ...
        public MonoFlat_Button()
        {
            ...
            inactiveColor = Color.FromArgb(181, 41, 42);
            pressedColor = Color.FromArgb(165, 37, 37);
        }
