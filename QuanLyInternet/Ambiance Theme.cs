...
class Ambiance_Button_1 : Control
{
    ...
    public Ambiance_Button_1()
    {
        ...
        InActiveColor = Color.FromArgb(253, 252, 252);
        InActiveColor2 = Color.FromArgb(239, 237, 236);
        // P1 = Border color
    }
    ...
    protected override void OnResize(System.EventArgs e)
    {
        ...
        if (Width > 0 && Height > 0)
        {
            ...
            InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), InActiveColor, InActiveColor2, 90f);
